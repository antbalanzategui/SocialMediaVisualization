 ...
 * Class: testCompareByEngagementRate
 * Tests the compareByEngagementRate class.
 * @author Nana Yaw Barimah Oteng(nanayawo21)
 * 
 * @version 2022.12.02
 */
public class testCompareByEngagementRate extends TestCase {
     ...
     */
    public void setUp() {      
        comp = new CompareByEngagementRate(MonthEnum.JANUARY, "Traditional Engagement Rate");
